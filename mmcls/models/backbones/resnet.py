...
class BasicBlockCG(BaseModule):
    ...
    def __init__(self,
                 ...
                 init_cfg=None):
        super(BasicBlockCG, self).__init__(init_cfg=init_cfg)
        ...
        self.conv1 = CGConv2d(in_channels, out_channels, kernel_size=3, 
                                stride=stride, padding=1, bias=False,
                                th=0.0, alpha=2.0,
                                use_group=True, shuffle=True, sparse_bp=True)
...
def get_expansion(block, expansion=None):
    ...
    if isinstance(expansion, int):
        ...
        if hasattr(block, 'expansion'):
            ...
            expansion = 1
        elif issubclass(block, BasicBlockCG):
            expansion = 1
